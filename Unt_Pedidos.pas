...
begin
    //Para ao fechar o programa ele ser desalocado da memória e não ficar rodando em segundo plano
    FrmPedidos.Free;
end;
...
begin
    ...
    cdsPedidos.Open;
    //Para ativar a PageCentro e a primeira TableSheet dela abrir é a TSCONSULTA
